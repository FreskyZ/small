...
Windows ISO file official download page https://www.microsoft.com/en-us/software-download/windows11
is broken and does not provide the download URL,
...
# not sure whether this bootup order configuration is needed,
# it seems that hyperv default goes to dvd drive if nothing is in vhd

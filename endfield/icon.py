...
# # manually copy response content in devtool and paste it in data/WikiItemData.json
# and then download, shrink images and convert to data uri

# rawWikiItems = json.load(open('data/WikiItemData.json'))
...
# with open('data/IconData.json', 'w') as f:
#     json.dump(newItems, f)

items = json.load(open('data/IconData.json'))
...
with open('data/IconData2.json', 'w') as f:
